...
export function MirrorChart({
  ...
  return (
    <div className="rounded-xl border border-soft-border bg-white p-8 shadow-soft-card transition-all duration-300 hover:-translate-y-2 hover:scale-[1.02] hover:shadow-soft-card-hover">
